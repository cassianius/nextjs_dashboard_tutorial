-- CreateEnum
CREATE TYPE "InterviewTopic" AS ENUM ('TECHNICAL_EXPERTISE', 'PROBLEM_SOLVING', 'LEADERSHIP', 'COMMUNICATION', 'PROJECT_EXECUTION', 'DOMAIN_KNOWLEDGE', 'ADAPTABILITY', 'INNOVATION');

-- CreateTable
CREATE TABLE "Topic" (
    "id" TEXT NOT NULL,
    "account_id" TEXT NOT NULL,
    "topic" "InterviewTopic" NOT NULL,
    "goal" TEXT NOT NULL,
